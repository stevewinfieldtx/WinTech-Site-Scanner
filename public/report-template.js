...
(function() {
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    @media print {
      ...
      .dl-btn, button { display:none !important; }
      ...
      body.print-single .pnl.active { display:block !important; page-break-before: avoid; }
  ...
  <div class="cnt">
    ...
    <!-- Per-dimension drill-downs are appended at the end (after Revenue / Audience) so the
         printed report reads summary-first, then the detailed breakdowns. -->
    ...
    <!-- PER-DIMENSION DRILL-DOWNS (WinTech Insights) — full breakdown appendix -->
    ${dimPanelsHtml}
